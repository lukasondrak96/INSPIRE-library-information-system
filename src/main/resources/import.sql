...
insert into loan (id_loan, state, start_date, id_client) VALUES (1, 'NOT_YET_RETURNED', '2021-09-10', 1);
insert into loan (id_loan, state, start_date, id_client) VALUES (2, 'RETURNED_ON_TIME', '2021-09-10', 2);
insert into loan (id_loan, state, start_date, id_client) VALUES (3, 'RETURNED_LATE', '2021-09-01', 3);
insert into loan (id_loan, state, start_date, id_client) VALUES (4, 'NOT_YET_RETURNED', '2021-09-03', 3);

insert into loan_of_item(id_loan_of_item, end_date, state, id_item, id_loan) VALUES (1, '2021-09-17', 'NOT_YET_RETURNED', 1, 1);
insert into loan_of_item(id_loan_of_item, end_date, state, id_item, id_loan) VALUES (2, '2021-09-17', 'RETURNED_ON_TIME', 2, 1);
insert into loan_of_item(id_loan_of_item, end_date, state, id_item, id_loan) VALUES (3, '2021-09-09', 'RETURNED_ON_TIME', 3, 2);
insert into loan_of_item(id_loan_of_item, end_date, state, id_item, id_loan) VALUES (4, '2021-09-09', 'RETURNED_LATE', 3, 3);
insert into loan_of_item(id_loan_of_item, end_date, state, id_item, id_loan) VALUES (5, '2021-09-11', 'NOT_YET_RETURNED', 4, 4);